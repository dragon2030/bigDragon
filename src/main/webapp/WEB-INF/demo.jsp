...
<!-- plug_in -->
<script type="text/javascript" src="resources/js/plug_in/qrcode.js"></script>
<script type="text/javascript" src="resources\js\plug_in\w2ui\w2ui-1.5.rc1.min.js"></script>
<link rel="stylesheet" type="text/css" href="resources\js\plug_in\w2ui\w2ui-1.5.rc1.min.css" />
<script type="text/javascript" src="resources/js/plug_in/parsley.js"></script>
<script type="text/javascript" src="resources/js/plug_in/parsley.min.js"></script>
<link rel="stylesheet" type="text/css" href="resources/js/plug_in/parsley.css" />
...
<!-- <script type="text/javascript" src="resources/js/model_js/plug_in.js"></script> -->
<!-- model js -->
...
<body>
	...
	<button id="test_Map_Json" class="test_Map_Json" onclick="test_Map_Json()">测试map-json转换</button>
 	...
 	<a id="loading_btn" href="<%=basePath%>test/loading?loading_path=C:\Users\3759\Desktop\wallpaper\timg.jpg">loading</a>
    ...
    <c:url value="/test/loading" var="downurl">
 	...
 	<!-- <img src="test/showImgGet?pathName=D://FPS//10_093427_18.JPG" alt="" /> -->
...
/* 		var loading_path=$("#loading").val();
		...
		window.location.href("test/loading?loading_path=C:\Users\3759\Desktop\壁纸\timg.jpg");
	  });
